...
The files in the [installer/package/install](installer/package/install) folder record the packages we want to install.
...
``` sh
apt install -y --install-recommends calamaris calamares-settings-debian
```




## Folder: `installer/package/install`

The files in the [installer/package/install](installer/package/install) folder have the file extension `.txt`.
